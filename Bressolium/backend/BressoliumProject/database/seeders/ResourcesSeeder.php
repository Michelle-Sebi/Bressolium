...
class ResourcesSeeder extends Seeder
{
    public function run(): void
    {
        $materials = [
            ...
            ['name' => 'pino',                'tier' => 1, 'group' => 'bosque'], // Nv2
            ['name' => 'carbon-natural',      'tier' => 2, 'group' => 'bosque'], // Nv3
            ...
            ['name' => 'granito',         'tier' => 1, 'group' => 'cantera'], // Nv2
            ...
            ['name' => 'cana-comun',       'tier' => 1, 'group' => 'rio'], // Nv2
            ['name' => 'tierras-fertiles', 'tier' => 2, 'group' => 'rio'], // Nv3
            ['name' => 'hidrogeno',        'tier' => 4, 'group' => 'rio'], // Nv5
            ['name' => 'gases-naturales',  'tier' => 4, 'group' => 'rio'], // Nv5

            // Prado
            ['name' => 'lino',   'tier' => 0, 'group' => 'prado'], // Nv1
            ['name' => 'yute',   'tier' => 1, 'group' => 'prado'], // Nv2
            ['name' => 'canamo', 'tier' => 2, 'group' => 'prado'], // Nv3
            ['name' => 'lana',   'tier' => 3, 'group' => 'prado'], // Nv4

            // Mina
            ['name' => 'cobre',       'tier' => 0, 'group' => 'mina'], // Nv1
            ['name' => 'hierro',      'tier' => 1, 'group' => 'mina'], // Nv2
