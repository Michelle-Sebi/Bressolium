...
- Tarea 55: `[Fix] Inventory Panel — Nombres de materiales e iconos de inventos` (Frontend - Michelle) [Talla: XS] [En revisión]
  - *Bloqueado por: T52*
- Tarea 56: `[Fix] VotingPanel — Bloqueo de flujo al descubrir todas las tecnologías` (Frontend/Backend - Michelle) [Talla: S] [En revisión]
...
| S4 | T10(M), T11(M), T12(L), T29(L), T31(M), T33(M), T42(M), T43(M), T44(S) | T13(XL), T19(M), T39(M), T50(S), T51(M), T52(XS), T53(M), T54(XS), T55(XS), T56(S) |
